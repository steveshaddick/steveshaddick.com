...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NoWork.date_checked'
        db.alter_column(u'ss_com_nowork', 'date_checked', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'NoWork.date_shown'
        db.alter_column(u'ss_com_nowork', 'date_shown', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Work.date_added'
        db.alter_column(u'ss_com_work', 'date_added', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'NoWork.date_checked'
        db.alter_column(u'ss_com_nowork', 'date_checked', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'NoWork.date_shown'
        db.alter_column(u'ss_com_nowork', 'date_shown', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        u'ss_com.nowork': {
            ...
            'date_checked': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
