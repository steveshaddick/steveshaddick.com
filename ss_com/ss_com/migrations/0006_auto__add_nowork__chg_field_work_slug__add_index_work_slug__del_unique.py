...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'ss_com_work', ['slug'])

        # Adding model 'NoWork'
        db.create_table(u'ss_com_nowork', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nowork_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('date_shown', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date_checked', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'ss_com', ['NoWork'])


        # Changing field 'Work.slug'
        db.alter_column(u'ss_com_work', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
        # Adding index on 'Work', fields ['slug']
        db.create_index(u'ss_com_work', ['slug'])


    def backwards(self, orm):
        # Removing index on 'Work', fields ['slug']
        db.delete_index(u'ss_com_work', ['slug'])

        # Deleting model 'NoWork'
        db.delete_table(u'ss_com_nowork')


        # Changing field 'Work.slug'
        db.alter_column(u'ss_com_work', 'slug', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))
        # Adding unique constraint on 'Work', fields ['slug']
        db.create_unique(u'ss_com_work', ['slug'])
