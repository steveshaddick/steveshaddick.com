...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoWork.has_audio'
        db.add_column(u'ss_com_videowork', 'has_audio',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VideoWork.allow_scrub'
        db.add_column(u'ss_com_videowork', 'allow_scrub',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoWork.has_audio'
        db.delete_column(u'ss_com_videowork', 'has_audio')

        # Deleting field 'VideoWork.allow_scrub'
        db.delete_column(u'ss_com_videowork', 'allow_scrub')
